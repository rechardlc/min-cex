...
func (x *GetUserRequest) GetA() float64 {
	if x != nil {
		return x.A
	}
	return 0
...
func (x *GetUserRequest) GetB() float64 {
	if x != nil {
		return x.B
	}
	return 0
...
func (x *GetUserResponse) GetSum() float64 {
	if x != nil {
		return x.Sum
	}
	return 0
...
const file_user_proto_rawDesc = "" +
	...
	"\x01b\x18\x03 \x01(\x01R\x01b\"X\n" +
	"\x0fGetUserResponse\x12\x17\n" +
	"\auser_id\x18\x01 \x01(\tR\x06userId\x12\x1a\n" +
	"\bnickname\x18\x02 \x01(\tR\bnickname\x12\x10\n" +
	"\x03sum\x18\x03 \x01(\x01R\x03sum2E\n" +
	"\vUserService\x126\n" +
	"\aGetUser\x12\x14.user.GetUserRequest\x1a\x15.user.GetUserResponseB\vZ\t./pb_userb\x06proto3"
